                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input name="username" readonly value="${sessionScope.user.username}" id="name" type="text" class="form-control" disabled="true">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input name="email" value="${sessionScope.user.email}" id="email" type="email" class="form-control">
                                            </div>
                                        </div>
