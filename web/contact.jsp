                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="card features feature-primary text-center border-0">
                            ...
                            <div class="card-body p-0 mt-3">
                                ...
                                <a href="tel:888195313" class="link">0985059321</a>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="card features feature-primary text-center border-0">
                            ...
                            <div class="card-body p-0 mt-3">
                                <h5>Email</h5>
                                <a href="mailto:support@doctriscare.ml" class="link">support@doctriscare.com</a>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 mt-lg-0 pt-2 pt-lg-0">
                        <div class="card features feature-primary text-center border-0">
                            ...
                            <div class="card-body p-0 mt-3">
                                <h5>Địa chỉ</h5>
                                <a href="#" class="link">Đại học FPT Hà Nội</a>
                            </div>
                        </div>
                    </div>
                </div>
